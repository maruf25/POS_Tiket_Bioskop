...
@section('content')
    <section id="choose-chair" class="bg-white p-3" style="border-radius: 20px">
            ...
            <div class="row g-3 mb-3">
                <div class="col-6">
                    <div class="seats">
                        ...
                        <div class="seat">
                            <input type="checkbox" name="A2" id="A2" value="A2">
                            <label for="A2">A2</label>
                        </div>
                        <div class="seat">
                            <input type="checkbox" name="A3" id="A3" value="A3">
                            <label for="A3">A3</label>
                        </div>
                        <div class="seat">
                            <input type="checkbox" name="A4" id="A4" value="A4">
                            <label for="A4">A4</label>
                        </div>
                        <div class="seat">
                            <input type="checkbox" name="A5" id="A5" value="A5">
